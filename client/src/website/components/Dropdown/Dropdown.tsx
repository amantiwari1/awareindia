  ...
  return (
    <div>
      <div tw="relative inline-block text-left">
        ...
        {isActive &&
          <div ref={dropdownRef} tw=" z-20 origin-bottom-right absolute right-0 mt-1 w-36 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none dark:(bg-darkmode2 border-blue-50)" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
